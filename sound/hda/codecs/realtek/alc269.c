...
static const struct hda_quirk alc269_fixup_tbl[] = {
	...
	SND_PCI_QUIRK(0x1558, 0x2560, "Clevo V255RN[MNP]", ALC256_FIXUP_SYSTEM76_MIC_NO_PRESENCE),
	SND_PCI_QUIRK(0x1558, 0x2624, "Clevo L240TU", ALC256_FIXUP_SYSTEM76_MIC_NO_PRESENCE),
	SND_PCI_QUIRK(0x1558, 0x28c1, "Clevo V370VND", ALC2XX_FIXUP_HEADSET_MIC),
	SND_PCI_QUIRK(0x1558, 0x2a00, "Clevo L240JU", ALC256_FIXUP_SYSTEM76_MIC_NO_PRESENCE),
	...
	SND_PCI_QUIRK(0x1558, 0x8361, "Clevo V560GN[MNP]", ALC256_FIXUP_SYSTEM76_MIC_NO_PRESENCE),
	...
	SND_PCI_QUIRK(0x1558, 0xf551, "Clevo L550JN[MNP]", ALC256_FIXUP_SYSTEM76_MIC_NO_PRESENCE),
